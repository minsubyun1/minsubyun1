...
|   프로젝트명    |                                   설명                                    |        기간         |        역할         |                                 링크                                  |
|:----------:|:-----------------------------------------------------------------------:|:-----------------:|:-----------------:|:-------------------------------------------------------------------:|
|  펫어웰       | [2025 kakao X groom 시즌톤] 🐾 반려동물을 잃은 뒤 보호자가 겪는 상실 극복을 돕는 기록·위로 커뮤니티 서비스 | 2025.08 ~ 2025.09 |      Backend      | [펫어웰](https://github.com/9oormthon-univ/2025_SEASONTHON_TEAM_23_BE) |
| FinanceDoc |       [개방형 클라우드 플랫폼(K-PaaS) 활용 공모전] 청년을 위한 지출 관리, 금융 상품 추천 서비스                        | 2025.08 ~ 2025.11 |      Backend      |               [파이낸스닥](https://github.com/Finance-doc)               |
